...
public class MouseListener {
    ...
    public static Vector2f getWorld() {
        ...
        currentX = (2.0f * ((currentX / get().gameViewportSize.x))) - 1;
    ...
    public static Vector2f screenToWorld(Vector2f screenCoords) {
        ...
        normalizedScreenCoords.mul(2.0f).sub(new Vector2f(1f, 1f));
        Camera camera = Window.getScene().camera();
    ...
    public static Vector2f worldToScreen(Vector2f worldCoords) {
        ...
        Matrix4f proj = new Matrix4f(camera.getProjectionMatrix());
